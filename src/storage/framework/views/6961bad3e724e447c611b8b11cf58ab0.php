...
<?php $__env->startSection('title', $service?->exists ? 'Editar Servicio' : 'Nuevo Servicio'); ?>

<div>
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-white"><?php echo e($service?->exists ? 'Editar Servicio' : 'Nuevo Servicio'); ?></h1>
            <p class="text-sm text-gray-400 mt-1"><?php echo e($service?->exists ? "Editando: {$service->title}" : 'Crear un nuevo servicio'); ?></p>
        </div>
        <a href="<?php echo e(route('admin.services.index')); ?>" wire:navigate class="px-4 py-2 text-sm text-gray-400 hover:text-white transition">
            ← Volver
        </a>
    </div>
            ...
            <div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button type="button" wire:click="toggleSlugEditor" class="text-xs text-gray-500 hover:text-gray-300 transition">
                        <?php echo e($autoSlug ? 'Personalizar' : 'Auto'); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="flex items-center justify-end gap-3">
            <a href="<?php echo e(route('admin.services.index')); ?>" wire:navigate
            ...
            <button type="submit"
                ...
                <?php echo e($service?->exists ? 'Actualizar' : 'Crear servicio'); ?>

            </button>
        </div>
    </form>
</div>
<?php /**PATH /var/www/resources/views/livewire/admin/service-form.blade.php ENDPATH**/ ?>