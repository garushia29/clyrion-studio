...
>
    ...
    <div
        x-show="show"
        class="mb-6 bg-surface-card border border-surface-border rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full <?php echo e($maxWidth); ?> sm:mx-auto"
        x-transition:enter="ease-out duration-300"
