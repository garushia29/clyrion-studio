<div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($visible): ?>
        ...
        >
            <div class="<?php echo e($type === 'success' ? 'bg-green-600' : 'bg-red-600'); ?> text-white px-4 py-3 rounded-lg shadow-lg flex items-center justify-between">
...
<?php /**PATH /var/www/resources/views/livewire/components/flash-message.blade.php ENDPATH**/ ?>