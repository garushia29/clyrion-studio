...
<div <?php echo e($attributes->merge(['class' => 'card overflow-hidden'])); ?>>
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            <?php ($headerList = count($headers) > 0 ? $headers : $columns); ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($headerList) > 0): ?>
